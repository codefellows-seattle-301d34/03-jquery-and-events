...
articleView.handleMainNav = function() {
  ...
  $('nav').on('click','.tab', function () {
    $('.tab-content').hide();
    let choice =$(this).attr('data-content');
    $(`#${choice}`).fadeIn(500);
  })
...
articleView.setTeasers = function() {
  ...
  $('.read-on').on('click', function(){
    ...
    let author = $(this).parent().attr('data-author');
    $(`article[data-author="${author}"] .article-body *`) .show();
    $(`article[data-author="${author}"] .read-on`) .hide();
  })
